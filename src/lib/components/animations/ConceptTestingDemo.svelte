...
{#if show}
  <div
    ...
    class="flex flex-col items-center space-y-8 p-8"
  >
    <!-- Concepts Input -->
    {#if conceptsVisible}
      <div in:fade={{ duration: 600 }} class="flex gap-4">
        <div
          class="flex h-12 w-20 items-center justify-center rounded-lg bg-blue-200"
        >
          <div class="h-3 w-3 rounded bg-blue-500"></div>
        </div>
        <div
          class="flex h-12 w-20 items-center justify-center rounded-lg bg-green-200"
        >
          <div class="h-3 w-3 rounded bg-green-500"></div>
        </div>
        <div
          class="flex h-12 w-20 items-center justify-center rounded-lg bg-purple-200"
        >
