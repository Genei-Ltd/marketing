...
<div class="h-156 flex w-full overflow-hidden rounded">
  ...
  <div
    class="bg-card text-card-foreground px-xl py-xl flex flex-col justify-center w-1/2"
  >
    <div class="space-y-sm">
      ...
      {#if showButton}
        ...
        >
          ...
          <IconArrowRight
            class="group-hover:translate-x-1 w-4 h-4 transition-transform"
          />
        </Button>
      {/if}
    </div>
  ...
  <div class="bg-accent-1 p-xl flex items-center justify-center w-1/2">
    {@render children?.()}
  </div>
</div>
